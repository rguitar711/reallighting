...
?>
 ...
 //submitting form for save
                     ...
                     if(!isset($_POST['ddl_vendor']) || empty($_POST['ddl_vendor']) )
                        {
                            ...
                            redirect2("http://".$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI].'?custID='.getpost('id').'&FormMode=Edit&Error=2');
                        ...
                        else
                        {
                            ...
                            if($vendorId == '1')
                            {
                                $checkSql = "Select propertyCode from customers where propertyCode = '" .@$_POST['INT_CO_CODE']."' and custId <> " .getpost('id');
                            }
                            if($vendorId == '2')
                            {
                                $checkSql = "Select INT_CO_CODE from customers where INT_CO_CODE = '" .@$_POST['INT_CO_CODE']."' and custId <> " . getpost('id');   
                            }
                            //Coupa
                            if($vendorId == '3')
                            {
                                $checkSql = "Select fce_property_code from customers where fce_property_code = '" .@$_POST['INT_CO_CODE']."' and custId <> " .getpost('id');  
                            }
		...
		$resultCheck = ect_query($checkSql) or print(mysql_error());
                
                        if(mysql_num_rows($resultCheck)>0){

                        redirect2("http://".$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI].'?custID='.getpost('id').'&FormMode=Edit&Error=1');
                        ...
                        else
                        {
                                $vendorId = $_POST['ddl_vendor'];
                                    ...
                                    if($vendorId == '1')
                                    {
                                        ...
                                        $updateCode = "update customers set propertyCode = '" .@$_POST['INT_CO_CODE']."', INT_CO_CODE = '', fce_property_code='' where custId ="  . getpost('id');
                                    ...
                                    if($vendorId == '2')
                                    {
                                        ...
                                        $updateCode = "update customers set INT_CO_CODE = '" .@$_POST['INT_CO_CODE']."',propertyCode = '',fce_property_code='' where custId ="  . getpost('id');
                                                echo $updateCode;
                                                exit();
                                      ...
                                      if($vendorId == '3')
                                    {
                                        ...
                                        $updateCode = "update customers set fce_property_code = '" .@$_POST['INT_CO_CODE']."',propertyCode = '', INT_CO_CODE='' where custId ="  . getpost('id');
                                          
                                    }



                                $resultCheck = ect_query($updateCode) or print(mysql_error());
                        }
                 }
?>
<?php		writehiddenvar('posted', '1');
				...
				<option value="16"<?php if(($clActions & 16)==16) print ' selected="selected"' ?>><?php print $yyPerDis?></option>
                        ...
                        ?>
                          <?php
                            ...
                            $result2 = ect_query($sql) or print(mysql_error());
                            
                            ?>
                        <tr><td align="right"><strong>Vendor:</strong></td><td align="left">
            ...
            <?php 
             ...
             <tr><td align="right"><strong>Property Code:</strong></td><td align="left"><input type="text" name="INT_CO_CODE" value="<?php if(isset($_POST['INT_CO_CODE'])){ echo $_POST['INT_CO_CODE'];} else { echo $vendorType;} ?>" /><span style="color:#FF0000;"><?php print $warning; ?></span></td></tr>
			  <tr>
