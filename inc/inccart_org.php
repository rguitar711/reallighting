...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		if($theproduct == escape_string($alldata['cartProdID']) ){
 		...
 		print '<div class="cartlinetotal"><input type="checkbox" name="ck_homepage-' . $counter . '" id="ck_homepage" value="' . escape_string($alldata['cartProdID']) . '"  checked></div>'; 

		}else
		{
		print '<div class="cartlinetotal"><input type="checkbox" name="ck_homepage-' . $counter . '" id="ck_homepage" value="' . escape_string($alldata['cartProdID']) . '"/></div>'; 
